...
from final_model.model_training.dataset import BrainToTextDataset, train_test_split_indicies
...
class BrainToTextDecoder_Trainer:
    ...
    def __init__(self, args):
        ...
        # These are validation blocks that contain OpenWebText or Random corpus data
        # We only want to validate on Switchboard corpus data
